define("gallery/ztree/3.5.3/ztree-debug", [ "$-debug" ], function(require, exports, module) {
    require("gallery/ztree/3.5.3/zTree.css");
...
define('gallery/ztree/3.5.3/zTree.css', [], function() {
