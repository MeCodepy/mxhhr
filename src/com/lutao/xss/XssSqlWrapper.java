...
public class XssSqlWrapper extends HttpServletRequestWrapper {
	private HttpServletRequest orgRequest;

	public XssSqlWrapper(HttpServletRequest request) {
		super(request);
	...
	public static HttpServletRequest getOrgRequest(HttpServletRequest req) {
		if (req instanceof XssSqlWrapper) {
			return ((XssSqlWrapper) req).getOrgRequest();
		}
		return req;
	}
